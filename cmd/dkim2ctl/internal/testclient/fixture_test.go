...
const validHealthFixture = `{"schema":"dkim2ctl.fixture.v1","draft":"draft-ietf-dkim-dkim2-spec-04","fixture":"fixture-a","cases":[{"case":"case-a","kind":"health","expect":{"http_status":200,"health_status":"alive"}}]}`
...
func TestStableOutputOrderAndNullPolicy(t *testing.T) {
	...
	const expected = `{"schema":"dkim2ctl.result.v1","draft":"draft-ietf-dkim-dkim2-spec-04","fixture":null,"case":null,"operation":null,"outcome":"match","http_status":null,"error_class":null,"duration_bucket":null,"disposition":null,"verification_state":null,"policy_verdict":null,"replay_class":null}` + "\n"
