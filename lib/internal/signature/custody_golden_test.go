...
// TestDraft04CustodyGoldenVectors locks immutable adjacent custody semantics.
func TestDraft04CustodyGoldenVectors(t *testing.T) {
	...
	if golden.Draft != "draft-ietf-dkim-dkim2-spec-04" || len(golden.CustodyCases) == 0 {
