...
The pinned upstream, Debian, and Ubuntu source-package matrix is release
qualified only when all five rows import against the exact unchanged candidate
snapshot. The repository does not claim a published image, package, tag, or
