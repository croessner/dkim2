...
const generationGoldenDraft06 = "draft-ietf-dkim-dkim2-spec-06"
...
// TestRetainedGenerationDraft06Evidence verifies reachable state, policy, outcome, reconstruction, and canonical fixtures.
func TestRetainedGenerationDraft06Evidence(t *testing.T) {
	fixture := loadRetainedGenerationFixture(t)
	if fixture.Draft != generationGoldenDraft06 || len(fixture.SerializerCases) == 0 || len(fixture.GenerationCases) == 0 {
...
func loadRetainedGenerationFixture(t *testing.T) retainedGenerationFixture {
	t.Helper()
	data, err := os.ReadFile("testdata/golden/recipe-generation-draft-ietf-dkim-dkim2-spec-06.json")
	if err != nil {
...
func validateRetainedGenerationFixture(fixture retainedGenerationFixture) error {
	if fixture.Draft != generationGoldenDraft06 {
...
func TestRetainedGenerationFixtureRejectsSchemaDrift(t *testing.T) {
	...
	duplicateField := bytes.Replace(data, []byte("\"draft\": \"draft-ietf-dkim-dkim2-spec-06\","), []byte("\"draft\": \"draft-ietf-dkim-dkim2-spec-06\",\n  \"draft\": \"draft-ietf-dkim-dkim2-spec-06\","), 1)
