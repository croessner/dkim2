...
const recipeGenerationDraftBaseline = "draft-ietf-dkim-dkim2-spec-06"
...
// TestSerializeGenerationPlanMatchesDraft06Goldens verifies exact versioned JSON bytes.
func TestSerializeGenerationPlanMatchesDraft06Goldens(t *testing.T) {
