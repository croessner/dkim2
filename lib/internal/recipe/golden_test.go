...
const recipeApplicationDraftBaseline = "draft-ietf-dkim-dkim2-spec-06"
...
// TestGoldenRecipeApplicationDraft06 verifies draft-versioned reconstruction examples.
func TestGoldenRecipeApplicationDraft06(t *testing.T) {
...
func loadRecipeGoldenFixture(t *testing.T) recipeGoldenFixture {
	...
	const path = "testdata/golden/recipe-application-draft-ietf-dkim-dkim2-spec-06.json"
