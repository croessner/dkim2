...
var reportEvidencePaths = []string{
	...
	".artifacts/image-evidence/dkim2-dsn-propagator.release.json",
	...
	".artifacts/image-evidence/dkim2-dsn-propagator.oci.json",
	".artifacts/image-evidence/dkim2-dsn-propagator.provenance.json",
...
var reportEvidenceSchemas = map[string]string{
	...
	".artifacts/image-evidence/dkim2-dsn-propagator.release.json":    "dkim2-image-release-report-v1",
	".artifacts/image-evidence/dkim2-dsn-propagator.oci.json":        "dkim2-oci-policy-v1",
	".artifacts/image-evidence/dkim2-dsn-propagator.provenance.json": "https://in-toto.io/Statement/v1",
